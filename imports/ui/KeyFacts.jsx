...
export class KeyFacts extends Tracker.Component {
  ...
  //Folgende 3 Methoden berechnen den Unterschied der aktuellen Followeranzahl zu der vor 7 Tagen 
  getFollower(){
  ...
  //Folgende 3 Methoden berechnen den Unterschied der aktuellen Retweetanzahl zu der vor 7 Tagen 
  getRetweets(){
  ...
  //Folgende 3 Methoden berechnen den Unterschied der aktuellen Mentionanzahl zu der vor 7 Tagen 
  getMentions() {
  ...
  //Folgende 2 Methoden berechnen den Unterschied der aktuellen Autorenanzahl von Mentions zu der vor 7 Tagen 
